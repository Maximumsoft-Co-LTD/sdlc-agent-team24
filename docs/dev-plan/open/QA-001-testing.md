...
- [ ] (1) register → browse → ซื้อ/เช่า (mock) → อ่าน
- [ ] (2) wallet เติม (mock) → จ่ายเหรียญ
- [ ] (3) publisher submit → admin approve → ผู้ใช้เห็น
- [ ] IDOR / security spot-check: publisher ไม่เห็นข้อมูลของรายอื่น
