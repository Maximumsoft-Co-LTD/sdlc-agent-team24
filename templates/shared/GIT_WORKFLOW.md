...
This document is the single source of truth for how every agent uses git on {{PROJECT_NAME}}. Agents must follow it; the `git-workflow` skill executes it. If anything here conflicts with another doc, **this file wins**.
